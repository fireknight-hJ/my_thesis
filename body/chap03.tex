...
\begin{lstlisting}[style=Python,language=Python, caption={MMIO表达式收集查询示例}]
import cpp
...
\begin{lstlisting}[style=Python,language=Python, caption={常量基址数据流追踪查询示例}]
...
\begin{lstlisting}[style=Python,language=Python, caption={函数参数类型匹配查询示例}]
