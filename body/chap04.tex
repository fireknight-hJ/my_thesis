...
\begin{tabular}{lccc}
\toprule
\textbf{固件名称} & \textbf{基本块覆盖率} & \textbf{执行速度（exec/s）} & \textbf{发现 Crash} \\
\midrule
NXP\_LwIP\_FreeRTOS & 18.5\% & 3,456 & 0 \\
NXP\_LwIP\_BareMetal & 22.7\% & 2,891 & 8 \\
LwIP\_HTTP\_Server\_Raw & 15.8\% & 4,123 & 0 \\
LwIP\_HTTP\_Server\_SocketRTOS & 26.4\% & 3,567 & 6 \\
LwIP\_StreamingServer & 19.5\% & 4,234 & 5 \\
\midrule
\textbf{平均} & \textbf{20.6\%} & \textbf{3,654} & \textbf{3.8} \\
\bottomrule
\end{tabular}
\end{table}
